...
function JSX({ lineNumber, space, width, y = 0, x = 0 }) {
    const lines = (new Array(lineNumber)).fill(0).map((data, index) => {
        ...
        return React.createElement("line", { x2: width, y1: yLine, y2: yLine, key: index });
    });
    return (React.createElement("g", { transform: `translate(${x}, ${y})`, stroke: 'black', strokeWidth: '0.5' }, lines));
}
var Staff = {
    JSX
};
...
function DotBuilder({ x = 0, y = 0, type }) {
    switch (type) {
        case 'single':
            return React.createElement(SingleDot.JSX, { x: x, y: y });
        case 'double':
            return React.createElement(DoubleDot.JSX, { x: x, y: y });
        case 'triple':
            return React.createElement(TripleDot.JSX, { x: x, y: y });
        default:
            return undefined;
    }
}
...
function JSX$5({ up = true }) {
    return up ? React.createElement("path", { stroke: 'black', strokeWidth: '1', d: 'M 12.076271,2.9131353 V -30' }) : React.createElement("path", { stroke: 'black', strokeWidth: '1', d: 'M 0.6,7 V 39.9131353' });
}
var Stem = {
    height: height$4,
    JSX: JSX$5
...
function JSX$7({ x = 0, y = 0 }) {
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement("path", { d: 'M 7.8164802,9.3315293 C 4.4659422,10.74664 1.3024237,9.8194673 0.30146123,7.4499503 -0.69944487,5.0804923 0.84126673,2.1660273 4.191802,0.75069028 c 3.3504822,-1.415394 7.242065,-0.79547 8.242971,1.57404702 1.000906,2.369461 -1.267758,5.591399 -4.6182928,7.006792 z' })));
}
var HeadNote = {
    width: width$5,
    height: height$6,
...
function JSX$8({ x = 0, y = 0, isStemUp = true }) {
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement(HeadNote.JSX, null),
        React.createElement(Stem.JSX, { up: isStemUp })));
}
var QuarterNote = {
    width: width$6,
...
function JSX$b({ x = 0, y = 0 }) {
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement("path", { d: 'm 6.3588713,-9 -1.198899,0.1320592 v 7.4073571 l -2.2966586,0.609056 v -7.0989782 l -1.1988438,0.1320592 v 7.284733 L 0,-0.0927193 v 3.064529 L 1.6644699,2.5308153 V 9.075673 L 0,9.516667 v 3.063227 L 1.6644699,12.13885 V 19 l 1.1988438,-0.132115 v -7.048216 l 2.2966586,-0.608984 v 6.739562 l 1.198899,-0.132115 v -6.925361 l 1.674005,-0.443634 V 7.3859369 L 6.3588713,7.8295876 V 1.2847304 l 1.674005,-0.4436507 v -3.0632 l -1.674005,0.4436507 z M 5.1599723,1.6028253 V 8.146426 L 2.8633137,8.755411 V 2.2105541 Z' })));
}
var Sharp = {
    width: width$9,
    height: height$a,
...
function JSX$d({ x = 0, y = 0 }) {
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement("path", { d: 'M 1.3146058,9.006223 5.7456234,7.83243 V 1.311395 L 1.3146058,2.485181 Z M 5.7456234,10.914596 0,12.436728 V -8.8552072 L 1.3146058,-9 v 8.401853 L 7.060165,-2.1202723 V 18.855316 L 5.7456234,19 Z' })));
}
var Natural = {
    width: width$b,
    height: height$c,
...
function JSX$f({ x = 0, y = 0 }) {
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement(Flat.JSX, { x: 0, y: 0 }),
        React.createElement(Flat.JSX, { x: 8.33, y: 0 })));
}
var DoubleFlat = {
    width: width$d,
    height: height$e,
...
function AccidentalUpstreamBuilder({ x = 0, y = 0, type, distanceSpace = 0 }) {
    switch (type) {
        case 'sharp':
            return React.createElement(Sharp.JSX, { x: x - (Sharp.width + distanceSpace), y: y });
        case 'double sharp':
            return React.createElement(DoubleSharp.JSX, { x: x - (DoubleSharp.width + distanceSpace), y: y });
        case 'natural':
            return React.createElement(Natural.JSX, { x: x - (Natural.width + distanceSpace), y: y });
        case 'flat':
            return React.createElement(Flat.JSX, { x: x - (Flat.width + distanceSpace), y: y });
        case 'double flat':
            return React.createElement(DoubleFlat.JSX, { x: x - (DoubleFlat.width + distanceSpace), y: y });
        default:
            return undefined;
    }
}
...
function JSX$g({ y = 0, x = 0 }) {
    return (React.createElement("line", { transform: `translate(${x}, ${y})`, stroke: 'black', strokeWidth: '0.5', x2: width$e, y1: 0.25, y2: 0.25 }));
}
var Ledger = {
    JSX: JSX$g
};
...
function noteBuilder(props) {
    ...
    return Object.assign(Object.assign(Object.assign({}, props), note), { renderFunc: function () {
            ...
            const ledgersJsx = ledgers && ledgers.map((y, index) => {
                return React.createElement(Ledger.JSX, { key: index, x: -5, y: y });
            });
            return (React.createElement("g", { key: id, transform: `translate(${x}, ${y})` },
                React.createElement(JSX, { isStemUp: isStemUp }),
                dot && React.createElement(DotBuilder, { type: dot, x: width + space, y: height / 2 - space }),
                accidental && React.createElement(AccidentalUpstreamBuilder, { type: accidental, distanceSpace: space }),
                ledgersJsx));
        } });
}
    ...
    return Object.assign(Object.assign({}, props), { width, height: 0, renderFunc: function () {
            ...
            if (keySigNumber > 0) {
                keySignature = accidentalMap.get('sharp').slice(0, keySigNumber).map((keyY, index) => {
                    return React.createElement(Sharp.JSX, { x: index * (Sharp.width + space$1), y: keyY, key: index });
                });
            }
            else {
                keySignature = accidentalMap.get('flat').slice(0, Math.abs(keySigNumber)).map((keyY, index) => {
                    return React.createElement(Flat.JSX, { x: index * (Flat.width + space$1), y: keyY, key: index });
                });
            }
            return (React.createElement("g", { key: id, transform: `translate(${x}, ${y})` }, keySignature));
        } });
}
...
function JSX$h({ x = 0, y = 0 }) {
    return (React.createElement("path", { transform: `translate(${x}, ${y})`, d: 'M 0,0 V 4 H 12 L 12,0 z', fill: 'black' }));
}
var WholeHalfRest = {
    width: width$f,
    height: height$f,
...
function restBuilder(props) {
    ...
    return Object.assign(Object.assign(Object.assign({}, props), restType), { renderFunc: function () {
            ...
            return React.createElement(JSX, { key: id, x: x, y: y });
        } });
}

const width$j = 1;
function JSX$l({ x = 0, y = 0, height = 0 }) {
    return (React.createElement("rect", { transform: `translate(${x}, ${y})`, width: 1, height: height }));
}
var BarLine = {
    width: width$j,
    JSX: JSX$l
...
function JSX$m({ x = 0, y = 0, height = 0 }) {
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement("rect", { width: 1, height: height }),
        React.createElement("rect", { x: '5', width: 1, height: height })));
}
var DoubleBarLine = {
    width: width$k,
    JSX: JSX$m
...
function JSX$n({ x = 0, y = 0, height = 0 }) {
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement("rect", { width: 1, height: height }),
        React.createElement("rect", { x: '3', width: 3, height: height })));
}
...
function barlineBuilder(props) {
    ...
    return Object.assign(Object.assign(Object.assign({}, props), barlineType), { renderFunc: function () {
            ...
            return React.createElement(JSX, { key: id, x: x, y: y, height: height });
        } });
}
...
function JSX$q({ upper, lower, x = 0, y = 0 }) {
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement("text", { transform: `translate(${0}, ${20})`, style: textStyle }, upper),
        React.createElement("text", { transform: `translate(${0}, ${40})`, style: textStyle }, lower)));
}
var TimeSignature = {
    width: width$o,
    height: height$l,
...
function timeSignatureBuilder(props) {
    return Object.assign(Object.assign(Object.assign({}, TimeSignature), props), { renderFunc: function () {
            ...
            return React.createElement(TimeSignature.JSX, { key: id, x: x, y: y, upper: upper, lower: lower });
        } });
}
...
function JSX$r({ x1, y1, x2, y2, place = 'under' }) {
    ...
    return (React.createElement("path", { d: `M ${x1} ${y1} C ${curAx} ${curAy}, ${curBx} ${curBy}, ${x2} ${y2} L ${B1.x} ${B1.y} C ${curB1x} ${curB1y}, ${curA1x} ${curA1y}, ${A1.x} ${A1.y} Z`, strokeWidth: 0.1, stroke: 'none', fill: 'black' }));
}
var Slur = {
    width: width$p,
    height: height$m,
...
function slurBuilder(props) {
    return Object.assign(Object.assign(Object.assign({}, Slur), props), { renderFunc: function () {
            ...
            return React.createElement(JSX, { key: id, x1: x1, y1: y1, x2: x2, y2: y2, place: place });
        } });
}
...
function beamBuilder(props) {
    return Object.assign(Object.assign({ height: 0, width: 0 }, props), { renderFunc: function () {
            ...
            return React.createElement("path", { key: id, d: beamPath, fill: 'black' });
        } });
}
...
function Stave({ x = 0, y = 0, elements = [], slurs = [], width }) {
    ...
    return (React.createElement("g", { transform: `translate(${x}, ${y})` },
        React.createElement(Staff.JSX, { lineNumber: 5, space: 10, width: width }),
        elementReactNodes,
        slurReactNodes,
        beamReactNodes));
}

class SvgMusicNotation extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            dimension: null
    ...
    componentDidMount() {
        ...
        const svgNode = ReactDOM.findDOMNode(this.smnRef.current);
    ...
    render() {
        ...
        const staveSourceMap = dimension && staves.map(({ id, elements, slurs }, index) => {
            return (React.createElement(Stave, { key: id, id: id, y: staveHeight * index + marginTop, width: dimension.width, elements: elements, slurs: slurs }));
        });
        return (
        ...
        //     {/* {editable && <ToolBar />} */}
        //     {/* sheet */}
        React.createElement("svg", { width: width, height: height, ref: this.smnRef }, staveSourceMap)
        // </div>
        );
    }
}

export { SvgMusicNotation };
