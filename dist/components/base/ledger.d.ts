import { Position, WidthDimension } from '@model/common.model';
import { BaseComponent } from '@base/interface/base.component';
interface LedgerProps extends WidthDimension {
}
export declare class Ledger extends BaseComponent {
    private props;
    constructor(props: LedgerProps, position?: Position);
