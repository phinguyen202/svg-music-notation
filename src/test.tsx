...
const treblestaveSource: SvgStaveSource = {
    ...
    elements: [
        ...
        { id: '4', type: 'note', duration: 'sixteenth', pitch: 'C4', slurTo: '5' },
        { id: '5', type: 'note', duration: 'sixteenth', pitch: 'C6' },
        { id: '6', type: 'note', duration: 'quarter', pitch: 'D4', slurTo: '7' },
        { id: '7', type: 'note', duration: 'quarter', pitch: 'E4' },
        { id: '8', type: 'note', duration: 'quarter', pitch: 'F4', slurTo: '9' },
        { id: '9', type: 'note', duration: 'quarter', pitch: 'G4' },
        { id: '10', type: 'note', duration: 'quarter', pitch: 'D5', slurTo: '11' },
        { id: '11', type: 'note', duration: 'quarter', pitch: 'C4' },
        ...
        { id: '17', type: 'note', duration: 'quarter', pitch: 'A5' , slurTo: '18'},
...
const treblestaveSource0: SvgStaveSource = {
    ...
    elements: [
        ...
        { id: '2', type: 'keySignature', keySigNumber: 7 },
        { id: '3', type: 'timeSignature', upper: 4, lower: 4 },
        { id: '4', type: 'note', duration: 'sixteenth', pitch: 'C6', slurTo: '5', beamGroup: '1'},
        { id: '5', type: 'note', duration: 'sixteenth', pitch: 'C4', beamGroup: '1' },
