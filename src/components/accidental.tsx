...
function DoubleFlat(props: AccProps) {
    return (
        <g transform={`translate(${props.x}, ${props.y})`}>
            <Flat x={0} y={0} />
            <Flat x={-9} y={0} />
...
function Natural(props: AccProps) {
    return (
        <g transform={`translate(${props.x}, ${props.y})`}>
...
function DoubleSharp(props: AccProps) {
    return (
        <g transform={`translate(${props.x}, ${props.y})`}>
